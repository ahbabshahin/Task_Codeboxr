                                    ...
                                    ?>
                                                <form method="post" id="create">
                                                      <div class="mb-3">
                                                            ...
                                                            <input type="text" name="title" class="form-control" id="title" value="<?= $row['title'] ?>" aria-describedby="emailHelp">
                                                      ...
                                                      <div class="mb-3">
                                                            ...
                                                            <textarea type="text" class="form-control" name="content" id="content"><?= $row['content'] ?></textarea>
